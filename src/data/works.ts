...
export const works: WorkItem[] = [
  {
    ...
    archiveSummary: '四拍倒数保持不变，目标的外观、位置、可见性和输入方式持续重组。',
    heroOrder: 1,
    caseOrder: 1,
    scenePreset: 'countdown-grid',
    role: '核心玩法与 13 组交互段落设计 / Godot 原型与系统实现 / 节奏判定与反馈整合',
    engine: 'Godot 4.6.3 / Windows',
    period: '2026-07-22 至 2026-07-26 / GMTK Game Jam 2026',
    summary:
      '2D 鼠标节奏观察游戏。以 4、3、2、1 为稳定语法，通过点击、禁拍、记忆、长按、拖拽、轨迹模仿和路径重构，持续改变玩家获取信息与执行输入的方式。',
    oneLine: '固定四拍作为共同骨架，十二个微型关卡逐步改变观察方式与鼠标操作。',
    contribution: [
      '设计教学段与十二个正式微型关卡，使四拍倒数从基础点击逐步扩展到空拍抑制、空间记忆、持续控制、轨迹模仿和路径重构。',
      '搭建音乐时间、拍点规则、输入判定、状态反馈、图像变化与关卡结算的统一结构，让不同关卡复用同一套节奏协议。',
      '将目标位置、运动轨迹、判定窗口、音乐片段、首拍偏移、转场时间和 Shader 参数暴露到 Godot 检查器，支持团队快速调整。',
      '完成加载、菜单、教学、失败重启、NEXT 转场和电视息屏结尾，并通过完整通关、单关重启与五组无界面回归脚本检查流程。',
    ],
    skills: ['节奏设计', '规则变体', 'Godot', '输入判定', '关卡递进', 'Shader 整合'],
    visualTheme: 'ui-panels',
    featured: true,
    proof: [
      { label: '项目类型', value: '2D 鼠标节奏 / 12 个正式微型关卡' },
      { label: '开发环境', value: '4 人团队 / 4 天 Game Jam' },
      { label: '公开反馈', value: '42 份评分 / 美术 #123 / 创意 #229' },
    ],
    designHighlights: [
      { title: '稳定语法', body: '4、3、2、1 始终作为共同骨架，新关卡只改变一个主要的信息或操作变量。' },
      { title: '规则递进', body: '显性目标逐步转为移动、空拍、隐藏位置、局部照明、轨迹和网络路径。' },
      { title: '系统结构', body: '音乐时间、拍点数据、输入判定、反馈与结算通过统一信号和接口协作。' },
      { title: '验证结果', body: 'CRT 画面和规则变化获得认可；后段教学速度、容差和注意力竞争成为下一轮重点。' },
    ],
    flow: ['观察线索', '预测下一拍', '鼠标输入', '节奏与视觉反馈', '更新规则认知'],
    media: [
      {
        type: 'image',
        src: './media/portfolio/click-down-network.gif',
        poster: './media/portfolio/click-down-network-poster.png',
        caption: 'NETWORK：四拍倒数被重构为持续变化的节点路径。',
      },
      {
        type: 'image',
        src: './media/portfolio/click-down-basic.gif',
        poster: './media/portfolio/click-down-basic-poster.png',
        caption: '基础四拍：按音乐时间依次完成 4、3、2、1。',
      },
      {
        type: 'image',
        src: './media/portfolio/click-down-drift.gif',
        poster: './media/portfolio/click-down-drift-poster.png',
        caption: '动态追踪：目标运动改变视觉搜索和点击预判。',
      },
      {
        type: 'image',
        src: './media/portfolio/click-down-light.gif',
        poster: './media/portfolio/click-down-light-poster.png',
        caption: 'LIGHT：局部照明把节奏点击转化为拖拽探索。',
      },
      {
        type: 'image',
        src: './media/portfolio/click-down-collage.gif',
        poster: './media/portfolio/click-down-collage-poster.png',
        caption: '超现实拼贴关卡：正确输入同时推进图像变化与节拍状态。',
      },
    ],
    download: {
      url: releaseBase + '/CLICKDOWN_Windows.zip',
      version: 'Windows Build / GMTK 2026',
      size: '约 84.7 MiB',
      sha256: 'AAFF395DB52689EBFD96B2E8DA1EEAE5DB1CA921782030D4B8B85BADEC09F227',
    },
    links: [
      { label: 'itch.io 游戏页与备用下载', url: 'https://ro-kiro.itch.io/click-down' },
      { label: 'GMTK Game Jam 2026 比赛页', url: 'https://itch.io/jam/gmtk-jam-2026/rate/4819745' },
      {
        label: '公开设计记录',
        url: 'https://qcnngi5i7r8n.feishu.cn/wiki/LBN9wn4B9ipyrrkbZ2Fc2w6AnBf?from=from_copylink',
      },
    ],
  },
  {
    ...
    shortTitle: 'HD2DKit',
    designQuestion: '怎样让没接触过 Godot 的新手完成场景搭建？',
    archiveSummary: '遮挡、碰撞、地图、角色与 NPC 流程被收进同一编辑器侧边栏。',
    heroOrder: 2,
    caseOrder: 4,
    scenePreset: 'tool-grid',
  ...
  },
  {
    ...
    designQuestion: '视线与距离如何制造持续累积的空间压力？',
    archiveSummary: '投掷锚、石化敌人、封锁路径，在倒计时中寻找逃脱窗口。',
    heroOrder: 4,
    caseOrder: 3,
    scenePreset: 'anchor-field',
  ...
  },
  {
    ...
    kind: 'Playable Prototype',
    shortTitle: 'Parry Arena',
    designQuestion: '防守如何在严格时机中转化为进攻？',
    archiveSummary: '普通格挡、完美弹反与闪避共同承担高压波次中的风险选择。',
    heroOrder: 3,
    caseOrder: 2,
    scenePreset: 'timing-gate',
    role: '独立开发 / 战斗规则 / 波次成长',
  ...
  },
  {
    ...
    kind: 'Playable Prototype',
    shortTitle: 'STATIC SIGNAL',
    designQuestion: '文字选择如何产生可感知的风险压力？',
    archiveSummary: '行动点、风险值、身份差异与多结局共同改变线索阅读顺序。',
    caseOrder: 5,
    scenePreset: 'signal-branch',
  ...
  },
  {
    ...
    kind: 'Playable Prototype',
    shortTitle: 'Prototype Modules',
    designQuestion: '模块化原型怎样缩短新玩法的试错路径？',
    archiveSummary: '移动、场景生成、刷怪和卡牌结算被拆成可复用的小型模块。',
    scenePreset: 'terrain-map',
  ...
  },
  {
    ...
    shortTitle: 'Delta Economy',
    designQuestion: '搜打撤经济如何让风险贯穿入局到撤离？',
    archiveSummary: '入局成本、撤离收益、交易流通与系统回收构成完整资源闭环。',
    scenePreset: 'economy-orbit',
  ...
  },
  {
    ...
    kind: 'System Analysis',
    shortTitle: 'Value Structure',
    designQuestion: '成长曲线如何改变角色养成与战斗收益判断？',
    archiveSummary: '属性层级、乘区结构和成长跳点被整理成可比较的数值路径。',
    scenePreset: 'value-lattice',
    role: '数值体系分析 / 成长曲线拆解',
    engine: '系统拆解报告 / 数据表',
    period: '2026',
    summary:
  ...
  },
  {
    ...
    title: '长线装备系统竞品分析',
    kind: 'System Analysis',
    shortTitle: 'Equipment Systems',
    designQuestion: '随机词条怎样兼顾追求感与长期负担？',
    archiveSummary: '获取、强化、套装与减负机制被放进统一维度比较。',
    scenePreset: 'artifact-rings',
    role: '竞品分析 / 养成系统对比',
  ...
  },
  {
    ...
    kind: 'System Analysis',
    shortTitle: 'Action Combat',
    designQuestion: '动作广度与操作精度怎样塑造不同战斗节奏？',
    archiveSummary: '多手段调度与高精度弹刀代表两条动作系统深度路径。',
    scenePreset: 'combat-cross',
    role: '动作系统拆解 / 战斗体验对比',
  ...
  },
  {
    ...
    kind: 'System Analysis',
    shortTitle: 'Roguelite Loop',
    designQuestion: '失败反馈如何支撑下一局与长期动机？',
    archiveSummary: '叙事推进、操作精进、随机控制与元进度共同回答再次开局。',
    scenePreset: 'run-cycle',
